...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '语江', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的公民', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-ivory-seven-62.vercel.app/', // 网站地址
